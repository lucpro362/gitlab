...
class App {
  ...
  editProduct(
    ...
    if (productEditIndex >= 10) {
      ...
      error.innerHTML = "Khong co san pham nay";
    }
  }
    ...
    for (let key in this.products) {
      ...
      productHtml += `<tr>
        ...
        <td>
            ...
            <button class="edit" data-id="${item.id}">Cập nhật</button>
  ...
  initDeleteHandle(thisOfApp) {
    ...
    btnDeletes.forEach(function (productItem) {
      productItem.addEventListener("click", function () {
        ...
        let status = confirm("Bạn có chắc chắn xóa?");
        if (status) {
...
let imageLink =
  "https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lh9axxo17zg2a4";
let imageLink1 =
  "	https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/1/_/1_252.jpg";
let product = new Product("1", "Ipod", 1000, imageLink);
let product2 = new Product(3, "Iphone", 3000, imageLink1);
